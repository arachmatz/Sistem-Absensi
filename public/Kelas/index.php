      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <div class="box-header">
              <a class="btn btn-primary btn-lg" href="<?php url("Kelas/add/") ?>"><span class="fa fa-user-plus"></span></a><br><br>
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                    ...
                    $kelas->queryCustom("desc ".strtolower($request->get(0)))->ready();
                    ...
                    $kelas->select($kelas->getTable())->ready();
                    $total = $kelas->getstatement()->rowCount();
                    ...
                    if($column = $search->matchingColumn($request->getValue('q'))){
                      ...
                      $kelas->select($kelas->getTable())->limit($nilaiAwal,$batas)->ready();
                    }
                    ...
                    ?>
                      <tr>
                        ...
                        <?php $guru = new \model\Guru();
                              $guru->select($guru->getTable())->where()->comparing('nip',$row['wali_kelas'])->ready();
                              $rowGuru = $guru->getStatement()->fetch();
                        ?>
                        <td><?php echo $rowGuru['nama_guru'] ?></td>
                        <td><a class="btn btn-warning" href="<?php url('Kelas/update/'.$row['id_kelas'].'/') ?>">Update</a></td>
                        <td>
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              ...
                              <li class="divider"></li>
                              <li><a href="<?php url('removeKelas/'.$row['id_kelas'].'/') ?>">iya</a></li>
              ...
              <ul class="pagination">
                <li class="page-item"><a href="<?php if($page <= 1){ echo"#"; }else{ url('Kelas/page/'.--$page.'/'); } ?>" class="page-link">Sebelumnya</a></li>
                <?php
                if($request->get(2) !== ""){
                    $page = $request->get(2);
                }else{
                ...
                for($i=1; $i <= $totalPage;$i++){ ?>
                    <li class="page-item <?php if($page == $i){?> active <?php } ?>"><a href="<?php url('Kelas/page/'.$i.'/') ?>" class="page-link"><?= $i ?></a></li>
                <?php } ?>

                <li class="page-item"><a href="<?php if($page >= $totalPage){ echo"#"; }else{ url('Kelas/page/'.++$page.'/'); } ?>" class="page-link">Setelahnya</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
