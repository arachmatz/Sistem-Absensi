        ...
        <div class="col-xs-10">
          <div class="box">
            <div class="box-header">
              <a class="btn btn-primary btn-lg" href="<?php url("Guru/add/") ?>"><span class="fa fa-user-plus"></span></a><br><br>
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php 
                    ...
                    // proses pencarian
                    $guru = new \model\Guru();
                    $guru->queryCustom("desc ".strtolower($request->get(0)))->ready();
                    ...
                    if($column = $search->matchingColumn($request->getValue('q'))){
                      ...
                      $guru->select($guru->getTable())->limit($nilaiAwal,$batas)->ready();
                    }
                    ...
                    while($row = $guru->getStatement()->fetch()){ 
                       ?>
                        <tr>
                        <td><img src="<?php getFiles($row['foto_guru']) ?>" alt="tanpa foto" class="user-profile img-responsive"></td>
                          <td><?php echo $row['nip'] ?></td>
                          <td><?php echo $row['nama_guru'] ?></td>
                          <td><?php echo $row['tanggal_lahir_guru'] ?></td>
                          <td><?php echo $row['jenis_kelamin_guru'] ?></td>
                          <td><?php echo $row['alamat_guru'] ?></td>
                          <td><a class="btn btn-warning" href="<?php url('Guru/update/'.$row['nip'].'/') ?>">Update</a></td>
                          <td>
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php url('removeGuru/'.$row['nip'].'/') ?>">iya</a></li>
              ...
              <ul class="pagination">
                <li class="page-item"><a href="<?php if($page <= 1){ echo"#"; }else{ url('Guru/page/'.--$page.'/'); } ?>" class="page-link">Sebelumnya</a></li>
                <?php
                if($request->get(2) !== ""){
                    $page = $request->get(2);
                }else{
                ...
                for($i=1; $i <= $totalPage;$i++){ ?>
                    <li class="page-item <?php if($page == $i){?> active <?php } ?>"><a href="<?php url('Guru/page/'.$i.'/') ?>" class="page-link"><?= $i ?></a></li>
                <?php } ?>

                <li class="page-item"><a href="<?php if($page >= $totalPage){ echo"#"; }else{ url('Guru/page/'.++$page.'/'); } ?>" class="page-link">Setelahnya</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
