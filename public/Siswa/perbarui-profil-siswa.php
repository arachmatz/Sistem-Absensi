  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-10">
      <div class="box">
        ...
        <form action="<?php url("updateSiswaProfil/") ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="tanggalLahir">Password</label>
                    <input type="text" class="form-control" id="tanggalLahir" name="password" value="<?php echo $rowUser['password'] ?>">
                </div>
