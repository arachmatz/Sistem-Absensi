  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-10">
      <div class="box">
        ...
        <form action="<?php url("addSiswa/") ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
                <div class="form-group">
                    <label for="idsiswa">nis</label>
                    <input type="text" class="form-control" id="idsiswa" placeholder="Masukan id" name="nis">
                </div>
                <div class="form-group">
                    <label for="namasiswa">Nama siswa</label>
                    <input type="text" class="form-control" id="namasiswa" name="nama_siswa" placeholder="Masukan nama">
                </div>
                <div class="form-group">
                    <label for="tanggalLahir">Tanggal Lahir</label>
                    <input type="date" class="form-control" id="tanggalLahir" name="tanggal_lahir_siswa">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_siswa" class="form-control" id="alamat" cols="30" rows="3" placeholder="Masukan alamat"></textarea>
                </div>
                    ...
                    <select class="form-control" id="Kelas" name="id_kelas_siswa">
                        <?php
                          ...
                          while($row = $kelas->getStatement()->fetch()){ ?>
                            <option value="<?= $row['id_kelas'] ?>"><?php echo $row['id_kelas'].' - '.$row['nama_kelas'] ?></option>
                        <?php 
                          }
                        ?>
                    </select>
