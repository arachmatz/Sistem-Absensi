      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <div class="box-header">
              <a class="btn btn-primary btn-lg" href="<?php url("Siswa/add/") ?>"><span class="fa fa-user-plus"></span></a><br><br>
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                    ...
                    $siswa->queryCustom("desc ".strtolower($request->get(0)))->ready();
                    ...
                    if($column = $search->matchingColumn($request->getValue('q'))){
                      ...
                      $siswa->select($siswa->getTable())->ready();
                    }
                    ...
                    if($column = $search->matchingColumn($request->getValue('q'))){
                      ...
                      $siswa->select($siswa->getTable())->limit($nilaiAwal,$batas)->ready();
                    }

                    if($siswa->getStatement()->rowCount() > 0){
                    while($row = $siswa->getStatement()->fetch()){ 
                    ?>
                      <tr>
                        <td><?php echo $no++ ?></td>
                        <td><img src="<?php getFiles($row['foto_siswa']) ?>" alt="tanpa foto" class="user-profile img-responsive"></td>
                        ...
                        <td><a class="btn btn-warning" href="<?php url('Siswa/update/'.$row['nis'].'/') ?>">Update</a></td>
                        <td>
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              ...
                              <li class="divider"></li>
                              <li><a href="<?php url('removeSiswa/'.$row['nis'].'/') ?>">iya</a></li>
              ...
              <ul class="pagination">
                <li class="page-item"><a href="<?php if($page <= 1){ echo"#"; }else{ url('Siswa/page/'.--$page.'/'); } ?>" class="page-link">Sebelumnya</a></li>
                <?php
                if($request->get(2) !== ""){
                    $page = $request->get(2);
                }else{
                ...
                for($i=1; $i <= $totalPage;$i++){ ?>
                    <li class="page-item <?php if($page == $i){?> active <?php } ?>"><a href="<?php url('Siswa/page/'.$i.'/') ?>" class="page-link"><?= $i ?></a></li>
                <?php } ?>

                <li class="page-item"><a href="<?php if($page >= $totalPage){ echo"#"; }else{ url('Siswa/page/'.++$page.'/'); } ?>" class="page-link">Setelahnya</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
